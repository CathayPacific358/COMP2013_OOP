...
public class Rectangle extends Shape {
	...
	public void resize(double newWidth, double newLength) {//2 input resize function
		this.width = newWidth;
	...
	public static void testRectangle() {
		...
		Rectangle r2 = new Rectangle(1.0, 2.0, 2.0, 4.0);
		...
		r2.resize(1.0, 2.0);//test 2 input resize
		System.out.println(r2.area() == 2.0);//test area after 2 input resize
	}
